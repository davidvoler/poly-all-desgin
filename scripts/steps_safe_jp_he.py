...
async def get_sentences_for_words(lang,to_lang,word,min_words, max_words = 0, word_num = 1):
    ...
    join content_raw.translation_links  trans2 on trans2.id  = trans.to_id and trans2.to_lang = %s
    join content_raw.sentences sentences on sentences.id = trans2.to_id
...
if __name__ == "__main__":
    ...
    asyncio.run(generate_course_by_rank("ja", "he", rank=False))
