...
const LanguageCard = ({ source, target, progressPercent, courseName }) => (
  <div className="card">
    {courseName && (
      <div style={{
    ...
    {courseName && (
      <h2 style={{
        ...
        margin: "0 0 16px 0", lineHeight: 1.2, letterSpacing: "-.01em"
      }}>{courseName}</h2>
    )}
...
const HomePage = ({ options, setOption, onStartQuiz, onOpenDemos, onOpenProgress, sentenceCount, totalCount }) => {
  ...
  return (
    <div className="page page-home">
      ...
      <LanguageCard source={source} target={target} progressPercent={45} courseName="Japanese for Beginners" />
