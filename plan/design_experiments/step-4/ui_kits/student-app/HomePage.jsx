...
const HomePage = ({ options, setOption, onStartQuiz, onOpenDemos, onOpenProgress, onOpenCourse, sentenceCount, totalCount }) => {
  ...
  const lessons = (typeof COURSE_LESSONS !== "undefined") ? COURSE_LESSONS : [];
  ...
  return (
    <div className="page page-home">
      ...
      <div style={{ padding: "12px 4px 16px" }}>
        ...
        <h1 style={{
          fontSize: 26, fontWeight: 400, color: "var(--fg-strong)",
          margin: 0, letterSpacing: "-.01em", lineHeight: 1.2,
        }}>Japanese for Beginners</h1>
        <div style={{
          display: "flex", alignItems: "center", gap: 8,
          fontSize: 13, color: "var(--fg-muted)", marginTop: 6,
        }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between",
          fontSize: 13, color: "var(--fg-muted)", margin: "14px 0 6px" }}>
      ...
      <div>
        {lessons.map(l => (
          <LessonRowList key={l.num} lesson={l} onClick={onStartQuiz} />
        ))}
      </div>
    </div>
  );
